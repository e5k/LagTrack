...
if strcmp(Volcano, 'MstHelens_May_1980')
    %% atmospheric file
    ncfile          = 'NetCDF_MtStHelens_May_1980.nc';                         % NetCDF file
    
    %% DEM file
    demfile         = 'dem_MtStHelens.mat';                                    % DEM file
...
%% Particle
part.diam       = 5 * 10^-2 ;                                              % Diameter (m)
part.dens       = 2500;                                                     % Density (kg/m3)
part.fl         = 0.5;                                                      % Flatness ( = shortest_length / intermediate_length)
part.el         = 0.5;                                                      % Elongation ( = intermediate_length / longest_length)
