...
%         t.m12 = uimenu(t.menu0, 'Label', 'Install ECMWF libraries', 'callback', 'installECMWFAPI');
    ...
    if strcmp(source.Parent.Title, 'SRTM')
    ...
    elseif strcmp(source.Parent.Title, 'Era-Interim')
        dwind_ECMWF(str2double(get(t.extentS, 'String')), str2double(get(t.extentN, 'String')), str2double(get(t.extentW, 'String')), str2double(get(t.extentE, 'String')), str2double(get(t.windYS, 'String')), str2double(get(t.windYE, 'String')), str2double(get(t.windMS, 'String')), str2double(get(t.windME, 'String')), get(t.nameE, 'String'))
    end